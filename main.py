...
from util.validation import parse_validation_results, summarise_validation, validate_html
...
if __name__ == "__main__":
	...
	if args.validate_only:
		...
		generate_html(model_name=MODEL_NAME, prompt=reprompt, output_path=reprompted_html_path)
